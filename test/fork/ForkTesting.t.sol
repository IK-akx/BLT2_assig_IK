...
contract ForkTestingTest is Test {
    ...
    function test_SimulateUniswapSwap_USDCtoWETH() public {
        ...
        uint256[] memory amounts = router.swapExactTokensForTokens(amountIn, 1, path, USDC_WHALE, deadline);
    ...
    function test_SimulateUniswapSwap_WETHtoDAI() public {
        ...
        uint256 deadline = block.timestamp + 120;
        uint256[] memory amounts = router.swapExactTokensForTokens(amountIn, 1, path, WETH_WHALE, deadline);
